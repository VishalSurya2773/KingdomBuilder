                ...
                try {
                    if (board[i][j].isEmpty() != true) {
                        if (board[i][j].getSettlement().getColor().equals("Red")) {
                            g.drawImage(settleRed, board[i][j].getCenterX(), board[i][j].getCenterY(), 30, 30,
                                    null);
                        } else if (board[i][j].getSettlement().getColor().equals("Green")) {
                            g.drawImage(settleGreen, board[i][j].getCenterX(), board[i][j].getCenterY(), 30,
                                    30, null);
                        } else if (board[i][j].getSettlement().getColor().equals("Blue")) {
                            g.drawImage(settleBlue, board[i][j].getCenterX(), board[i][j].getCenterY(), 30,
                                    30, null);
                        } else if (board[i][j].getSettlement().getColor().equals("Orange")) {
                            g.drawImage(settleOrange, board[i][j].getCenterX(), board[i][j].getCenterY(), 30,
                                    30, null);
                        } else if (board[i][j].getSettlement().getColor().equals("Yellow")) {
                            g.drawImage(settleYellow, board[i][j].getCenterX(), board[i][j].getCenterY(), 30,
                                    30, null);
                        } else if (board[i][j].getSettlement().getColor().equals("Purple")) {
                            g.drawImage(settlePurple, board[i][j].getCenterX(), board[i][j].getCenterY(), 30,
                                    30, null);
                        }
                    }
